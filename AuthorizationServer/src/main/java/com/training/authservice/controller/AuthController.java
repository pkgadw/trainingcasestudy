...
import com.training.authserver.security.model.AuthRequest;
import com.training.authserver.security.model.AuthResponse;
import com.training.authservice.security.util.JWTUtility;
...
public class AuthController {
	...
	public ResponseEntity<AuthResponse> authenticate(@RequestBody AuthRequest authRequest) throws Exception { 
		...
		String jwt = jWTUtility.getToken(authenticate);
